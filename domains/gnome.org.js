D("gnome.org", REG_GANDI,
    ...
    // FreeIPA (redirects via Fastly)
    CNAME("idm01", "dualstack.n.sni.global.fastly.net."),
    CNAME("idm02", "dualstack.n.sni.global.fastly.net."),
    ...
    CNAME("debuginfod", "1478120580.rsc.cdn77.org."),
    ...
    // Redirects (via Fastly)
    CNAME("api", "dualstack.n.sni.global.fastly.net."),
    CNAME("art", "dualstack.n.sni.global.fastly.net."),
    CNAME("bugs", "dualstack.n.sni.global.fastly.net."),
    CNAME("build", "dualstack.n.sni.global.fastly.net."),
    CNAME("chat", "dualstack.n.sni.global.fastly.net."),
    CNAME("developer", "dualstack.n.sni.global.fastly.net."),
    CNAME("ftp", "dualstack.n.sni.global.fastly.net."),
    CNAME("gis", "dualstack.n.sni.global.fastly.net."),
    CNAME("git", "dualstack.n.sni.global.fastly.net."),
    CNAME("hedgedoc", "dualstack.n.sni.global.fastly.net."),
    CNAME("i18n", "dualstack.n.sni.global.fastly.net."),
    CNAME("las", "dualstack.n.sni.global.fastly.net."),
    CNAME("library", "dualstack.n.sni.global.fastly.net."),
    CNAME("live", "dualstack.n.sni.global.fastly.net."),
    CNAME("news", "dualstack.n.sni.global.fastly.net."),
    CNAME("nl", "dualstack.n.sni.global.fastly.net."),
    CNAME("opw", "dualstack.n.sni.global.fastly.net."),
    CNAME("outreachy", "dualstack.n.sni.global.fastly.net."),
    CNAME("people", "dualstack.n.sni.global.fastly.net."),
    CNAME("projects", "dualstack.n.sni.global.fastly.net."),
    CNAME("projects-old", "dualstack.n.sni.global.fastly.net."),
    CNAME("src", "dualstack.n.sni.global.fastly.net."),
    CNAME("torrent", "dualstack.n.sni.global.fastly.net."),
    CNAME("torrents", "dualstack.n.sni.global.fastly.net."),
    CNAME("pygtk", "dualstack.n.sni.global.fastly.net."),

    // Custom domains for GitLab Pages
    CNAME("api.pygobject", "dualstack.n.sni.global.fastly.net."),
    CNAME("apps", "dualstack.n.sni.global.fastly.net."),
    CNAME("br", "dualstack.n.sni.global.fastly.net."),
    CNAME("brand", "dualstack.n.sni.global.fastly.net."),
    CNAME("cantarell", "dualstack.n.sni.global.fastly.net."),
    CNAME("circle", "dualstack.n.sni.global.fastly.net."),
    CNAME("donate", "dualstack.n.sni.global.fastly.net."),
    CNAME("fellowship", "dualstack.n.sni.global.fastly.net."),
    CNAME("forty", "dualstack.n.sni.global.fastly.net."),
    CNAME("glade", "dualstack.n.sni.global.fastly.net."),
    CNAME("gsoc", "dualstack.n.sni.global.fastly.net."),
    CNAME("gtkmm", "dualstack.n.sni.global.fastly.net."),
    CNAME("handbook", "dualstack.n.sni.global.fastly.net."),
    CNAME("icons.design", "dualstack.n.sni.global.fastly.net."),
    CNAME("libsoup", "dualstack.n.sni.global.fastly.net."),
    CNAME("nepal", "dualstack.n.sni.global.fastly.net."),
    CNAME("orca", "dualstack.n.sni.global.fastly.net."),
    CNAME("pygobject", "dualstack.n.sni.global.fastly.net."),
    CNAME("release", "dualstack.n.sni.global.fastly.net."),
    CNAME("thisweek", "dualstack.n.sni.global.fastly.net."),
    CNAME("tools.design", "dualstack.n.sni.global.fastly.net."),
    CNAME("tracker", "dualstack.n.sni.global.fastly.net."),
    CNAME("tracker.api", "dualstack.n.sni.global.fastly.net."),
    CNAME("welcome", "dualstack.n.sni.global.fastly.net."),
    ...
    // Matrix
    CNAME("policy.matrix", "ingress.openshift.gnome.org."),
    ...
    // GitLab
    ALIAS("gitlab", "dualstack.n.sni.global.fastly.net.", TTL(30)),
    ...
    CNAME("in", "dualstack.n.sni.global.fastly.net."),
    CNAME("gr", "dualstack.n.sni.global.fastly.net."),
    CNAME("fa", "dualstack.n.sni.global.fastly.net."),
